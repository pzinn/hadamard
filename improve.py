import torch
import params
from params import na, nm, nn, nn2, device, score, score_fft, score_fft_int, fft, fixed_sums, num_ones, real_dtype, complex_dtype, eps, gen_decay, cst, random_score, random_score_fft, random_score_fft_int, randomise_score_weights
import sys
