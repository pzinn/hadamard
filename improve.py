...
import torch
import params
from params import n, na, nm, nn, nn2, device, score, score_fft, fft, fixed_sums, num_ones, real_dtype, complex_dtype, eps, gen_decay, unfold
import sys
    ...
    for j in range(4):
        ...
        for t in range(100*n):  # ?
            ...
            if j==3:
                ...
                arrays[inds[improved],r1:r2] = x[improved,0:1] * x[improved,1:nn2+1]
